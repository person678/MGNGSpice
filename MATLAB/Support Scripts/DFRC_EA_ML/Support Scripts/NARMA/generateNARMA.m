...
inputSequence = benchmarkRangeScalar*inputSequence(memoryLength+washout+1:end);
outputSequence = benchmarkRangeScalar*outputSequence(memoryLength+washout+1:end);