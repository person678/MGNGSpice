function [inputSequence, outputSequence] = generateNARMA(sequenceLength, memoryLength, washout, benchmarkRangeScalar)
...
inputSequence = benchmarkRangeScalar*2*inputSequence(memoryLength+washout+1:end);
outputSequence = benchmarkRangeScalar*2*outputSequence(memoryLength+washout+1:end);